...
void ConfigParser::addSuboptionsIntgemm(cli::CLIWrapper& cli) {
  ...
  cli.add<bool>("--int8",
      "Optimize speed even more aggressively sacrificing memory or precision by using 8bit integer GEMM with intgemm or CUTLASS instead of floats. Corresponds to --gemm-precision int8");
  cli.add<bool>("--int8tensor",
      "Use tensor cores for CUTLASS when doing 8bit int operations.. Corresponds to --gemm-precision int8tensor");
  ...
  cli.add<std::string>("--gemm-precision",
      "Use lower precision for the GEMM operations only. Supported values: float32, int16, int8, int8tensor, int8Alpha, int8tensorAlpha, int8shift, int8shiftAlpha, int8shiftAll, int8shiftAlphaAll", "float32");
