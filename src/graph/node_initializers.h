...
/**
 * @brief Use a lambda function of form [](Tensor t) { do something with t } to initialize tensor
 * @param func functor
 */
...
/**
 * @brief Initialize tensor with given value
 *
...
/**
 * @brief Set diagonal of two dimensional quadratic matrix to `value`.
 *
...
/**
 * @brief Initialize tensor with normally distributed random numbers
 *
...
/**
 * @brief Initialize tensor with uniformly distributed random numbers
 *
 * Be default this generates floating point numbers from the
...
/**
 * @brief Initialize tensor with random numbers from Bernoulli Distribution
 *
...
/**
 * @brief Initialize tensor with random numbers from Glorot uniform distribution
 *
...
/**
 * @brief Initialize tensor with random numbers from Glorot Normal distribution
 *
...
/**
 * @brief Initialize with gumbel noise, i.e. -log(-log(u)) where u ~ Uniform(0 + eps, 1 - eps)
 *
 * @return A NodeInitializer
 */
...
/**
 * @brief Initialize tensor by *copying* from the given vector
 *
...
/**
 * @brief Initialize tensor by *moving* from the given vector
 *
 * Creates a NodeInitializer that will initialize the tensor
...
/**
 * @brief Initialize tensor from a given sparse vector
 *
 * Creates a NodeInitializer that will initialize the tensor
...
/**
 * @brief Initialize tensor by copying from the given io::Item
 *
 * Creates a NodeInitializer that will initialize the tensor
...
/**
 * @brief Initialize tensor by copying from the given tensor
 *
 * Creates a NodeInitializer that will initialize the tensor
...
/**
 * @brief Initialize tensor from a file
 *
 * Creates a NodeInitializer that will initialize the tensor
 ...
 * scaling to unit length</a>, i.e.,
 * dividing each element by the Euclidean length of the vector.
 *
 * @return A NodeInitializer
 */
...
/**
 * @brief Computes Google's sinusoidal position embeddings
 *
...
/**
 * @brief Computes a random rotation matrix for LSH hashing.
 *
...
/**
 * @brief computes the equivalent of Python's range()
 *
