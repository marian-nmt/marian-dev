...
struct SwishNodeOp : public UnaryNodeOp {
  ...
  virtual bool equal(Expr node) override {
    if(!NaryNodeOp::equal(node))
      return false;
    IPtr<SwishNodeOp> cnode = std::dynamic_pointer_cast<SwishNodeOp>(node);
    if(!cnode)
      return false;
    if(b_ != cnode->b_)
      return false;
...
struct ReduceNodeOp : public UnaryNodeOp {
  ...
  virtual bool equal(Expr node) override {
    if(!NaryNodeOp::equal(node))
      return false;
    IPtr<ReduceNodeOp> cnode = std::dynamic_pointer_cast<ReduceNodeOp>(node);
    if(!cnode)
      return false;
...
struct SqrtNodeOp : public UnaryNodeOp {
  ...
  virtual bool equal(Expr node) override {
    if(!NaryNodeOp::equal(node))
      return false;
    IPtr<SqrtNodeOp> cnode = std::dynamic_pointer_cast<SqrtNodeOp>(node);
    if(!cnode)
      return false;
...
public:
  ...
  virtual bool equal(Expr node) override {
    if(!NaryNodeOp::equal(node))
      return false;
    IPtr<ReshapeNodeOp> cnode = std::dynamic_pointer_cast<ReshapeNodeOp>(node);
    if(!cnode)
      return false;
...
public:
  ...
  virtual bool equal(Expr node) override {
    if(!NaryNodeOp::equal(node))
      return false;
    IPtr<SliceViewNodeOp> cnode = std::dynamic_pointer_cast<SliceViewNodeOp>(node);
    if(!cnode)
      return false;
...
struct ShiftNodeOp : public UnaryNodeOp {
  ...
  virtual bool equal(Expr node) override {
    if(!NaryNodeOp::equal(node))
      return false;
    IPtr<ShiftNodeOp> cnode = std::dynamic_pointer_cast<ShiftNodeOp>(node);
    if(!cnode)
      return false;
