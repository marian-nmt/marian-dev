...
__global__ static void gAddR2(Functor functor,
                       float* out,
                       ShapeGPU outShape,
                       const float* in1,
...
template <class Functor>
__global__ static void gAddR2Eq(Functor functor,
                         float* out,
                         ShapeGPU outShape,
                         const float* in1,
...
template <class Functor>
__global__ static void gAdd1R2(Functor functor,
                        float* out,
                        ShapeGPU outShape,
                        const float* in1,
                        const ShapeGPU in1Shape,
...
template <class Functor>
__global__ static void gAddR3(Functor functor,
                       float* out,
                       ShapeGPU outShape,
                       const float* in1,
                       const ShapeGPU in1Shape,
...
template <class Functor>
__global__ static void gAddR3Eq(Functor functor,
                         float* out,
                         ShapeGPU outShape,
                         const float* in1,
                         const ShapeGPU inShape1,
...
template <class Functor>
__global__ static void gAdd1R3(Functor functor,
                        float* out,
                        ShapeGPU outShape,
                        const float* in1,
                        const ShapeGPU in1Shape,
...
template <class Functor>
__global__ static void gAddR4(Functor functor,
                       float* out,
                       ShapeGPU outShape,
                       const float* in1,
                       const ShapeGPU in1Shape,
...
template <class Functor>
__global__ static void gAdd1R4(Functor functor,
                        float* out,
                        ShapeGPU outShape,
                        const float* in1,
                        const ShapeGPU in1Shape,
...
template <class Functor>
__global__ static void gAddR4Eq(Functor functor,
                         float* out,
                         ShapeGPU outShape,
                         const float* in1,
                         const ShapeGPU inShape1,
...
template <class Functor>
__global__ static void gElement(Functor functor,
                         float* out,
                         ShapeGPU outShape,
                         const float* in,
...
template <class Functor>
__global__ static void gElement(Functor functor, float* out, int length) {
  for(int bid = 0; bid < length; bid += blockDim.x * gridDim.x) {
    int index = bid + blockDim.x * blockIdx.x + threadIdx.x;
    if(index < length) {
...
template <class Functor>
__global__ static void gPick(Functor functor,
                      float* out,
                      ShapeGPU outShape,
                      const float* pick) {
  int length = outShape.elements();
...
template <class Functor>
__global__ static void gPickReduce(Functor functor,
                            float* out,
                            ShapeGPU outShape,
                            const float* in,
                            const ShapeGPU inShape,
