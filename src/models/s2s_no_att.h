...
class EncoderS2SNoAttention : public EncoderBase {
public:
  ...
  template <class... Args>
  EncoderS2SNoAttention(Ptr<Config> options, Args... args)
...
class DecoderS2SNoAttention : public DecoderBase {
private:
  Ptr<rnn::RNN> rnn_;
...
public:
  template <class... Args>
  DecoderS2SNoAttention(Ptr<Config> options, Args... args)
...
typedef EncoderDecoder<EncoderS2SNoAttention, DecoderS2SNoAttention> S2SNoAttention;
