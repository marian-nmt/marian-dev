...
static cublasStatus_t cublasLtAffineHelper(cublasLtHandle_t ltHandle, cublasOperation_t transA, cublasOperation_t transB,
                                           ...
                                           void* workspace, size_t workspaceSize, bool do_relu)  {
  ...
  cublasStatus_t opStatus = cublasLtMatmul(ltHandle, operationDesc, alpha, A, Adesc, B, Bdesc, beta, C, Cdesc, C, Cdesc, &heuristicResult.algo,
                                           workspace, workspaceSize, cudaStreamPerThread);
...
static cublasStatus_t cublasLtAffineTyped(cublasLtHandle_t ltHandle, cublasOperation_t transA, cublasOperation_t transB,
                                          ...
                                          float* workspace, size_t workspaceSizeBytes,bool do_relu) {
...
void affineTyped(marian::Tensor C, Ptr<Allocator> allocator, const marian::Tensor& A, const marian::Tensor& B, const marian::Tensor& bias,
  ...
  IPtr<MemoryPiece> workspace = allocator->alloc<T>(numWorkSpaceElts);  //TODO fix
  ...
  cudaStreamSynchronize(cudaStreamPerThread); // TODO fix
